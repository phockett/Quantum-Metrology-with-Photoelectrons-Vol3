...
1. The book itself is written as a set of Jupyter Notebooks.[^jupyterFootnote]  
    ...
    * The full book is compiled from these sections using the [Jupyter Book](https://jupyterbook.org/) project platform,[^jupyterBookFootnote] which includes build tools and specifications for the specific flavour of [Markdown (MyST)](https://mystmd.org/) used for the written text, and uses [Sphinx](https://www.sphinx-doc.org) to build HTML and Latex/PDF flavours of the book.
